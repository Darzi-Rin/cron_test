...
if __name__ == '__main__':
    ...
    shutil.move(im_name_change2, im_name_change)
    shutil.copy(im_name_change, 'C:/Users/student/Documents/cron_test/image_copy_tokyo')
    im = Image.open(im_name_change)
    im_crop = im.crop((496, 208, 646, 358))
    im_crop.save(im_name_change, quality=95)